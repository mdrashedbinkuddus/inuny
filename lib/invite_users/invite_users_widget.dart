    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('INVITE_USERS_arrow_back_rounded_ICN_ON_T');
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              'Select the friends to add to room.',
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: CheckboxListTile(
                                    ...
                                    subtitle: Text(
                                      listViewUsersRecord.university!,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText2
                                          .override(
                                            fontFamily: 'Lexend Deca',
          ...
          Container(
            ...
            child: Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('INVITE_USERS_ADD_TO_STUDY_ROOM_BTN_ON_TA');
