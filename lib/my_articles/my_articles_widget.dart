...
class MyArticlesWidget extends StatefulWidget {
  const MyArticlesWidget({Key? key}) : super(key: key);
...
class _MyArticlesWidgetState extends State<MyArticlesWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'MyArticles'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('MY_ARTICLES_PAGE_angleLeft_ICN_ON_TAP');
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'MY_ARTICLES_Container_wu2znzgj_ON_TAP');
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'MY_ARTICLES_delete_outline_rounded_ICN_O');
                                                logFirebaseEvent(
