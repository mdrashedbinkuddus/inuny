...
class CurriculumCopyWidget extends StatefulWidget {
  const CurriculumCopyWidget({
    Key? key,
    this.userDetails,
    this.experDetails,
  }) : super(key: key);
  ...
  final ExperienceRecord? experDetails;

  @override
  _CurriculumCopyWidgetState createState() => _CurriculumCopyWidgetState();
}

class _CurriculumCopyWidgetState extends State<CurriculumCopyWidget> {
  @override
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('CURRICULUM_COPY_angleLeft_ICN_ON_TAP');
